      ...
      <td style="padding: 1rem; background-color: #ffffff; border-radius: 0.5rem; margin: auto;">
        ...
        <div style="text-align: center; margin-bottom: 1.5rem;">
          ...
          <a href="{{ $apiUrl }}" style="text-decoration: none; cursor: pointer;">
            <button style="width: 180px; height: 35px; background-color: #b91c1c; border-radius: 0.5rem; border: 0; color: #ffffff; font-size: 0.8rem; transition: 1s; display: inline-block;">
